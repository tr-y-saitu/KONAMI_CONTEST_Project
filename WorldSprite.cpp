...
void WorldSprite::Initialize(int textureGraph, int chipPixelSize, int spriteNo)
{
    ...
    Vertex[0].u = (chipNoX + 0.0f) * oneChipUVRate;     // テクスチャの座標を設定
    Vertex[0].v = (chipNoY + 0.0f) * oneChipUVRate;     // uは横軸座標 vは縦軸座標
